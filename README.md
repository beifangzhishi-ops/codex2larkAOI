...
维护记录：2026-07-28 完成 AKA 会话对 AOI 文件修改及 AOI 服务重启验证；2026-08-11 约定本项目所有更新统一推送到 GitHub 的 `noha` 分支，并修复恢复会话回放中本地音频/图片 Markdown 残留 `!` 前缀的显示问题；计划确认卡片支持解析本地图片并以上传的 `img_key` 内嵌显示。
