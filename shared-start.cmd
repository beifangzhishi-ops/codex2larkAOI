...
if defined NO_PAUSE_ON_ERROR (
  powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\shared-stack.ps1" -Action start -NoGui
) else (
  powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\shared-stack.ps1" -Action start
)
